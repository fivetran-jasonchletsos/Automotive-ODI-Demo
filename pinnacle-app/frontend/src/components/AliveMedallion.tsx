      ...
      <div className="am-grid">
        ...
        <section className="am-zone am-zone-sources">
          ...
          <footer className="am-zone-footer">
            ...
            <span>CDC + batch via Fivetran <span style={{ color: '#9ca3af' }}>·</span> Vehicle telematics stream via Kafka</span>
          </footer>
        </section>
        ...
        <section className="am-zone am-zone-consumers">
          ...
          <div className="am-hipaa-band">
            ...
            <span className="am-hipaa-detail">TISAX · ISO 26262 · SOC 2 · row-level access · column masking</span>
          </div>
